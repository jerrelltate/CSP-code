...
// value {*} - the value to appear in every item of the list
...
//Returns a copy of the list given with each value multiplied by a given number
// list {list} - a list of numbers to be multiplied
// number {number} - the number to multiply each item in the list by
